...
class RingDetector(Node):
    def __init__(self):
        ...
        self.ring_image_sub = self.create_subscription(Image, "/oakd/rgb/preview/image_raw", self.ring_image_callback, 1)
        self.depth_sub = self.create_subscription(Image, "/oakd/rgb/preview/depth", self.depth_callback, 1)
        self.ring_pointcloud_sub = self.create_subscription(PointCloud2, "/oakd/rgb/preview/depth/points", self.ring_pointcloud_callback, qos_profile_sensor_data)

        self.elipse_image_sub = self.create_subscription(Image, "/oakd/rgb/preview/image_raw", self.elipse_image_callback, 1)
        self.elipse_pointcloud_sub = self.create_subscription(PointCloud2, "/oakd/rgb/preview/depth/points", self.elipse_pointcloud_callback, qos_profile_sensor_data)
    ...
    def ring_image_callback(self, data):
    ...
    def ring_pointcloud_callback(self, data):
    ...
    def elipse_image_callback(self, data):
    ...
    def elipse_pointcloud_callback(self, data):
